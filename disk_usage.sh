...
#echo "$message" | mail -s "High Disk usage" naveenbejugam1999@gmail.com

#how to call other shell script from your current script
sh mail.sh naveenbejugam1999@gmail.com "High Disk Usage" "$message" "DEVOPS TEAM" "High Disk usage"